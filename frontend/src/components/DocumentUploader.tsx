...
export function DocumentUploader({ onSessionCreated, showHeader = true }: DocumentUploaderProps) {
    ...
    <AnimatePresence mode="wait">
      ...
      {state === 'success' && (
        ...
        >
          ...
          <p className="text-muted-foreground text-sm">Processing your document...</p>
        </motion.div>
      )}
        ...
        >
          ...
          <div className="space-y-3">
            <div className="space-y-1.5">
              <Label htmlFor="doc-title" className="text-xs">Session Title *</Label>
              <Input
                id="doc-title"
                value={title}
            ...
            <div className="space-y-1.5">
              <Label htmlFor="doc-type" className="text-xs">Session Type</Label>
              <Select
                value={sessionType}
  ...
  // When embedded (showHeader=false), render without card wrapper
  if (!showHeader) {
    return content;
  }

  // Standalone usage with card wrapper
  return (
